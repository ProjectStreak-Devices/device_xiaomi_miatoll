...
void load_device_properties() {
    ...
    if (hwname == "curtana") {
        if (region == "Global_TWO") {
            ...
            property_override("ro.build.description", "curtana_global-user 11 RKQ1.200826.002 V12.5.1.0.RJWMIXM release-keys");
        } else if (region == "Global_PA") {
            set_device_props("Redmi", "curtana", "Redmi Note 9S");
            property_override("ro.build.description", "curtana_global-user 11 RKQ1.200826.002 V12.5.1.0.RJWMIXM release-keys");
        } else if (region == "India") {
            set_device_props("Redmi", "curtana", "Redmi Note 9 Pro");
            property_override("ro.build.description", "curtana-user 11 RKQ1.200826.002 V12.5.2.0.RJWINXM release-keys");
